      ...
      <View>
        ...
        return(
            ...
            <TouchableOpacity style={styles.button} onPress={()=>navigate('SATTestLoc')}>
                ...
                <Text style={{color:'white',fontSize:16, fontFamily:'FontBest',marginRight:width*0.0, marginLeft:width*0.005, textAlign:'center'}}>View the official SAT Test Center Locator</Text>
                </View>
            </TouchableOpacity>
            <View style ={{marginBottom:height*0.05}}>
