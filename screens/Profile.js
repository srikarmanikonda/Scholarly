...
/>
      ...
      <View style={{marginTop:'0%', marginBottom:'-0%',marginLeft:'0%'}}>
        <TouchableOpacity style={{width:width*0.57,height:height*0.1}}>
            <View style={{borderRadius: 8, paddingVertical: 15, paddingHorizontal: 15,backgroundColor: '#cc2b7e',justifyContent:'center'}}>
